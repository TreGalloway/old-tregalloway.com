...
import { Gear } from '../src/types/gear'
import GearCard from '../src/components/cards/gear-card'
        ...
        <>
            <VStack as="section" alignItems="flex-start" w="full" spacing={3}>
                ...
                <Text>
                    ...
                    <strong>Not affiliate links</strong>. To see my software
                    tools, check out the <Link href="/uses">Uses</Link> page.
                </Text>
            </VStack>
...
export const getStaticProps: GetStaticProps<Props> = async () => {
    const { gear: gearData } = await readData<{ gear: Gear[] }>(
        'data/gear.json'
    )
