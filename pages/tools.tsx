...
import ToolCard from '../src/components/cards/tool-card'
    ...
    return (
        <>
            <VStack as="section" alignItems="flex-start" w="full" spacing={3}>
                ...
                <Text>
                    This is my list of software tools that I use frequently. I
                    do my best at updating it whenever a change occurs. To see
                    my hardware, check out the <Link href="/gear">Gear</Link>{' '}
                    page.
                </Text>
            </VStack>
