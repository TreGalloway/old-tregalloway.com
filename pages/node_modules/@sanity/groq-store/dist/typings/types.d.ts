...
export interface GroqStore {
    ...
    subscribe: <R = any>(groqQuery: string, params: Record<string, unknown>, callback: (err: Error | undefined, result?: R) => void) => Subscription;
    close: () => Promise<void>;
}
...
export declare type StreamResult = SanityDocument | StreamError;
