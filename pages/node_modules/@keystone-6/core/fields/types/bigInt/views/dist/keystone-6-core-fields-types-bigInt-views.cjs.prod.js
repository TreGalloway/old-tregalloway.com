...
var CellLink = require('../../../../../dist/CellLink-ce70e3cf.cjs.prod.js');
  ...
  return {
    ...
    filter: {
      ...
      graphql: _ref5 => {
        ...
        const parsed = type === 'in' || type === 'not_in' ? valueWithoutWhitespace.split(',').map(x => BigInt(x)) : BigInt(valueWithoutWhitespace);
