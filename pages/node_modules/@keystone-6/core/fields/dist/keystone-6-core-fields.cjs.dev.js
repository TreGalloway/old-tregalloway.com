...
var mysql = require('../../dist/mysql-a6027d90.cjs.dev.js');
var jsonFieldTypePolyfillForSqlite = require('../../dist/json-field-type-polyfill-for-sqlite-f48ff1bf.cjs.dev.js');
var graphqlTsSchema = require('../../dist/graphql-ts-schema-8b76a11f.cjs.dev.js');
  ...
  return meta => {
    ...
    return mysql.fieldType({
      ...
      input: {
        ...
        where: {
          arg: apiWithoutContext.arg({
            type: jsonFieldTypePolyfillForSqlite.filters[meta.provider].BigInt[mode]
          }),
          resolve: mode === 'optional' ? jsonFieldTypePolyfillForSqlite.resolveCommon : undefined
        },
        create: {
...
const calendarDay = function () {
  ...
  return meta => {
    ...
    const commonResolveFilter = mode === 'optional' ? jsonFieldTypePolyfillForSqlite.resolveCommon : x => x;
    return mysql.fieldType({
      kind: 'scalar',
      mode,
...
const _excluded = ["ui", "defaultValue"];
// These are the max and min values available to a 32 bit signed integer
