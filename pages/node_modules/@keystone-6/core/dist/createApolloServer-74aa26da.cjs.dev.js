...
const createApolloServerMicro = _ref => {
  ...
  const context = async _ref2 => {
    ...
    return createContext({
      sessionContext: sessionStrategy ? await session_dist_keystone6CoreSession.createSessionContext(sessionStrategy, req, res, createContext) : undefined,
      req
    });
  };
