...
var orderable = require('./orderable-a2ee31ad.cjs.dev.js');
var button = require('@keystone-ui/button');
var api = require('./api-e2da1104.cjs.dev.js');
...
function replaceValueAtPropPath(schema, value, newValue, path) {
  ...
  if (schema.kind === 'conditional') {
    const conditionalValue = value; // replaceValueAtPropPath should not be used to only update the discriminant of a conditional field
    ...
    case 'array':
      {
        ...
        const keys = newVal.map(x => {
          ...
          let elementKey = getNewArrayElementKey(); // just in case someone gives a key that is above our counter
...
const OrderableItemInForm = /*#__PURE__*/React.memo(function OrderableItemInForm(props) {
  ...
  }, core.jsx(orderable.DragHandle, null), core.jsx(orderable.RemoveButton, null)), core.jsx(core.Box, {
    paddingX: "medium",
    paddingBottom: "medium"
  }, isNonChildFieldPreviewProps(props) && core.jsx(FormValueContentFromPreviewProps, props)));
});
...
function DefaultToolbarWithChrome(_ref) {
  ...
  return core.jsx(orderable.ToolbarGroup, {
    as: api.NotEditable,
    marginTop: "small"
  }, core.jsx(orderable.ToolbarButton, {
    onClick: () => {
      onShowEditMode();
    }
  }, "Edit"), core.jsx(orderable.ToolbarSeparator, null), core.jsx(tooltip.Tooltip, {
    content: "Remove",
    weight: "subtle"
  }, attrs => core.jsx(orderable.ToolbarButton, _extends({
    variant: "destructive",
    onClick: () => {
      onRemove();
    }
    ...
    size: "small"
  }))), !isValid && core.jsx(React.Fragment, null, core.jsx(orderable.ToolbarSeparator, null), core.jsx("span", {
    css: {
...
function FormValue(_ref2) {
  ...
  }, core.jsx(FormValueContentFromPreviewProps, _extends({}, props, {
    forceValidation: forceValidation
  })), core.jsx(button.Button, {
    size: "small",
    tone: "active",
...
function ChromelessComponentBlockElement(props) {
  ...
  return core.jsx("div", _extends({}, props.attributes, {
    ...
    ref: trigger.ref
  }), props.renderedBlock, props.isOpen && core.jsx(orderable.InlineDialog, _extends({}, dialog.props, {
    ref: dialog.ref
...
function addMissingFields(value, schema) {
  ...
  if (schema.kind === 'conditional') {
    ...
    return {
      discriminant: conditionalValue.value,
...
const BlockComponentsButtons = _ref => {
  ...
  return core.jsx(React.Fragment, null, Object.keys(blockComponents).map(key => core.jsx(orderable.ToolbarButton, {
    key: key,
    onMouseDown: event => {
      event.preventDefault();
...
const LayoutContainer = _ref => {
  ...
  }), children), focused && selected && core.jsx(orderable.InlineDialog, _extends({
    ref: dialog.ref
  }, dialog.props), core.jsx(orderable.ToolbarGroup, null, layoutOptions.map((layoutOption, i) => core.jsx(orderable.ToolbarButton, {
  ...
  }, makeLayoutIcon(layoutOption))), core.jsx(orderable.ToolbarSeparator, null), core.jsx(tooltip.Tooltip, {
    content: "Remove",
    weight: "subtle"
  }, attrs => core.jsx(orderable.ToolbarButton, _extends({
    variant: "destructive",
...
const ListButton = /*#__PURE__*/React.forwardRef(function ListButton(props, ref) {
  ...
  return React.useMemo(() => {
    ...
    return core.jsx(orderable.ToolbarButton, _extends({
      ref: ref,
...
function RelationshipButton(_ref) {
  ...
  return core.jsx(React.Fragment, null, Object.entries(relationships).map(_ref2 => {
    ...
    return core.jsx(orderable.ToolbarButton, {
      key: key,
      isDisabled: isDisabled,
      onMouseDown: event => {
        event.preventDefault();
...
const LinkElement = _ref => {
  ...
  return core.jsx("span", _extends({}, attributes, {
    ...
    ref: trigger.ref,
    href: href
  }), children), (selected && delayedFocused || focusedInInlineDialog) && core.jsx(orderable.InlineDialog, _extends({}, dialog.props, {
    ref: dialog.ref,
    onFocus: () => {
  ...
  }, core.jsx(orderable.ToolbarGroup, null, core.jsx("input", {
    css: {
      fontSize: typography.fontSize.small,
      width: 240
    },
...
const separator = core.jsx(orderable.ToolbarSeparator, null);
...
const LinkButton = /*#__PURE__*/React.forwardRef(function LinkButton(props, ref) {
  ...
  return React.useMemo(() => core.jsx(orderable.ToolbarButton, _extends({
    ref: ref,
    isDisabled: isDisabled,
    isSelected: isSelected,
    onMouseDown: event => {
    ...
    if (isInlineContainer(node)) {
      ...
      for (const [idx, child] of node.children.entries()) {
        ...
        if (child.type === 'link' && child.href === ((_lastMergableLink = lastMergableLink) === null || _lastMergableLink === void 0 ? void 0 : _lastMergableLink.node.href)) {
          ...
          const to = [...firstLinkPath, lastMergableLink.node.children.length]; // note this is going in reverse, js doesn't have double-ended iterators so it's a for(;;)
...
const blockquoteButton = core.jsx(tooltip.Tooltip, {
  content: core.jsx(React.Fragment, null, "Quote", core.jsx(orderable.KeyboardInTooltip, null, '> ')),
  weight: "subtle"
...
const codeButton = core.jsx(tooltip.Tooltip, {
  weight: "subtle",
  content: core.jsx(React.Fragment, null, "Code block ", core.jsx(orderable.KeyboardInTooltip, null, "```"))
...
const TextAlignMenu = _ref => {
  ...
  return core.jsx("div", {
    ...
    trigger: trigger,
    showMenu: showMenu
  })), showMenu ? core.jsx(orderable.InlineDialog, _extends({
    ref: dialog.ref
...
function TextAlignDialog(_ref2) {
  ...
  return core.jsx(orderable.ToolbarGroup, null, alignments.map(alignment => core.jsx(tooltip.Tooltip, {
    key: alignment,
...
const DividerButton = _ref => {
  ...
  return React.useMemo(() => /*#__PURE__*/React__default["default"].createElement(orderable.ToolbarButton, _extends({
    isDisabled: isDisabled,
    onMouseDown: event => {
      event.preventDefault();
...
const dividerButton = /*#__PURE__*/React__default["default"].createElement(tooltip.Tooltip, {
  content: /*#__PURE__*/React__default["default"].createElement(React.Fragment, null, "Divider", /*#__PURE__*/React__default["default"].createElement(orderable.KeyboardInTooltip, null, "---")),
  weight: "subtle"
...
function Toolbar(_ref) {
  ...
  return core.jsx(ToolbarContainer, null, core.jsx(orderable.ToolbarGroup, null, !!documentFeatures.formatting.headingLevels.length && core.jsx(HeadingMenu, {
  ...
  }), hasMarks && core.jsx(orderable.ToolbarSeparator, null), (documentFeatures.formatting.alignment.center || documentFeatures.formatting.alignment.end) && core.jsx(TextAlignMenu, {
    alignment: documentFeatures.formatting.alignment
  }), documentFeatures.formatting.listTypes.unordered && core.jsx(tooltip.Tooltip, {
    content: core.jsx(React.Fragment, null, "Bullet List ", core.jsx(orderable.KeyboardInTooltip, null, "- ")),
    weight: "subtle"
    ...
    content: core.jsx(React.Fragment, null, "Numbered List ", core.jsx(orderable.KeyboardInTooltip, null, "1. ")),
    weight: "subtle"
  }, attrs => core.jsx(ListButton, _extends({
    type: "ordered-list"
  }, attrs), core.jsx(NumberedListIcon, null))), (documentFeatures.formatting.alignment.center || documentFeatures.formatting.alignment.end || documentFeatures.formatting.listTypes.unordered || documentFeatures.formatting.listTypes.ordered) && core.jsx(orderable.ToolbarSeparator, null), documentFeatures.dividers && dividerButton, documentFeatures.links && linkButton, documentFeatures.formatting.blockTypes.blockquote && blockquoteButton, !!documentFeatures.layouts.length && core.jsx(LayoutsButton, {
    ...
    return viewState && core.jsx(orderable.ToolbarGroup, null, core.jsx(orderable.ToolbarSeparator, null), core.jsx(tooltip.Tooltip, {
...
function InsertBlockMenu() {
  ...
  return core.jsx("div", {
    ...
    content: core.jsx(React.Fragment, null, "Insert ", core.jsx(orderable.KeyboardInTooltip, null, "/")),
    weight: "subtle"
  }, _ref6 => {
    let {
      ref
    ...
    ref: dialog.ref
  }, dialog.props), core.jsx(orderable.ToolbarGroup, {
    direction: "column"
...
function InlineMarks(_ref7) {
  ...
  return core.jsx(React.Fragment, null, marks.bold && core.jsx(tooltip.Tooltip, {
    content: core.jsx(React.Fragment, null, "Bold", core.jsx(orderable.KeyboardInTooltip, null, modifierKeyText, "B")),
    weight: "subtle"
    ...
    content: core.jsx(React.Fragment, null, "Italic", core.jsx(orderable.KeyboardInTooltip, null, modifierKeyText, "I")),
    weight: "subtle"
  }, attrs => core.jsx(MarkButton, _extends({
    type: "italic"
...
function MoreFormattingDialog(_ref8) {
  ...
  return core.jsx(orderable.InlineDialog, _extends({
    onMouseDown: event => {
    ...
    type: "superscript"
  }, "Superscript"), core.jsx(orderable.ToolbarButton, {
    isDisabled: isDisabled,
    onMouseDown: event => {
      event.preventDefault();
...
function InsertMenu(_ref2) {
  ...
  return core.jsx(React.Fragment, null, core.jsx("span", _extends({}, trigger.props, {
    ...
    ref: trigger.ref
  }), children), core.jsx(core.Portal, null, core.jsx(orderable.InlineDialog, _extends({
    contentEditable: false
  }, dialog.props, {
    css: {
  ...
  }, options.map((option, index) => core.jsx(orderable.ToolbarButton, {
    key: option.label,
...
function withPasting(editor) {
  ...
  editor.insertData = data => {
    ...
    urlPattern.test(plain) && api.isValidURL(plain) && editor.selection && !slate.Range.isCollapsed(editor.selection) && // we only want to turn the selected text into a link if the selection is within the same block
...
const _excluded = ["onChange", "value", "componentBlocks", "relationships", "documentFeatures"];
const HOTKEYS = {
  'mod+b': 'bold',
  'mod+i': 'italic',
  'mod+u': 'underline'
...
function handleNodeInInvalidPosition(editor, _ref7, parentPath) {
  ...
  const childNodeInfo = editorSchema[nodeType]; // the parent of a block will never be an inline so this casting is okay
