...
function useDimensions(code, focus, minColumns, lineNumbers, deps) {
    ...
    const { prevLongestLine, nextLongestLine, element } = React__default["default"].useMemo(() => {
        ...
        const element = (React__default["default"].createElement("code", { className: "ch-code-scroll-parent" },
            ...
            lines.map((line, i) => (React__default["default"].createElement("div", { ref: line === prevLongestLine
                    ? prevLineRef
                    : undefined, key: i },
...
function SmoothContainer({ dimensions, codeStep, children, minZoom = 0, maxZoom = 1.2, center = false, progress, }) {
    ...
    return (React__default["default"].createElement(Container, { width: dimensions.containerWidth, height: dimensions.containerHeight },
...
function Wrapper({ htmlProps, style, children, }) {
    return (React__default["default"].createElement("div", Object.assign({}, htmlProps, { style: Object.assign(Object.assign({ margin: 0, padding: 0, position: "relative", 
...
function Preview(_a) {
    ...
    return (React__default["default"].createElement("div", { className: "ch-preview" + (className ? " " + className : ""), style: style },
        React__default["default"].createElement(MiniBrowser, Object.assign({ loadUrl: show, theme: codeConfig.theme }, rest, { children: presetConfig ? (React__default["default"].createElement(SandpackPreview, { files: files, presetConfig: presetConfig })) : (children) }))));
}
...
function Spotlight(_a) {
    ...
    const stepsChildren = React__default["default"].Children.toArray(children);
    const [state, setState] = React__default["default"].useState({
        stepIndex: start,
    ...
    return (React__default["default"].createElement("section", { className: `ch-spotlight ${presetConfig ? "ch-spotlight-with-preview" : ""} ${className || ""}`, style: style },
...
function Scrollycoding(_a) {
    ...
    return (React__default["default"].createElement("section", { className: `ch-scrollycoding ${presetConfig ? "ch-scrollycoding-with-preview" : ""} ${className || ""}`, style: style },
...
function Slideshow(_a) {
    ...
    return (React__default["default"].createElement("div", { className: `ch-slideshow ${presetConfig ? "ch-slideshow-with-preview" : ""} ${className || ""}`, style: style },
        ...
        React__default["default"].createElement("div", { className: "ch-slideshow-notes" },
            React__default["default"].createElement("div", { className: "ch-slideshow-range" },
                React__default["default"].createElement("button", { onClick: () => setState(s => {
                ...
                React__default["default"].createElement("input", { type: "range", min: 0, max: editorSteps.length - 1, value: state.stepIndex, step: 1, onChange: e => setState({
            ...
            hasNotes && (React__default["default"].createElement("div", { className: "ch-slideshow-note" }, stepsChildren[state.stepIndex])))));
}
