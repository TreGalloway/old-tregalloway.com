...
function transformSpotlight(node, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const editorSteps = yield extractStepsInfo(node, config, "merge steps with header");
        const presetConfig = yield getPresetConfig(node.attributes);
        toJSX(node, {
            props: {
...
function transformScrollycoding(node, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const editorSteps = yield extractStepsInfo(node, config, "merge step with previous");
        const presetConfig = yield getPresetConfig(node.attributes);
        transformLinks(node);
        toJSX(node, {
            props: {
...
function addConfigDefaults(config, cwd, filepath) {
    ...
    return Object.assign(Object.assign({}, config), { theme: (config === null || config === void 0 ? void 0 : config.theme) || {}, autoImport: (config === null || config === void 0 ? void 0 : config.autoImport) === false ? false : true, skipLanguages: (config === null || config === void 0 ? void 0 : config.skipLanguages) || [], filepath });
}
...
function transform(unsafeConfig) {
...
exports.remarkCodeHike = transform;
