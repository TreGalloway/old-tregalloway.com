...
function useDimensions(code, focus, minColumns, lineNumbers, deps) {
    ...
    const { prevLongestLine, nextLongestLine, element } = React.useMemo(() => {
        ...
        const element = (React.createElement("code", { className: "ch-code-scroll-parent" },
            ...
            lines.map((line, i) => (React.createElement("div", { ref: line === prevLongestLine
                    ? prevLineRef
                    : undefined, key: i },
...
function splitByFocus(mergedCode, focus, annotations) {
    ...
    const focusByLineNumber = map(focus, focus => mapFocusToLineNumbers(focus, lines));
...
function parse$1({ theme, focus, annotations, highlightedLines, }) {
...
function CodeTween(_a) {
    ...
    const { element, dimensions } = useDimensions(stepInfo.code, map(tween, tween => tween.focus), config.minColumns || DEFAULT_MIN_COLUMNS, config.lineNumbers || false, [config.parentHeight]);
...
function Wrapper({ htmlProps, style, children, }) {
    return (React.createElement("div", Object.assign({}, htmlProps, { style: Object.assign(Object.assign({ margin: 0, padding: 0, position: "relative", 
...
function startingPosition(prev, next, codeConfig) {
    ...
    return {
        ...
        northPanel: {
            ...
            children: (React.createElement(CodeTransition, { codeConfig: codeConfig, prevFile: prevNorthFile, nextFile: prevNorthFile, t: 0, parentHeight: "0" })),
        },
        ...
        southPanel: inputSouthPanel && {
            ...
            children: (React.createElement(CodeTransition, { codeConfig: codeConfig, prevFile: prevSouthFile, nextFile: prevSouthFile, t: 0, parentHeight: "0" })),
        },
    };
}
...
function endingPosition(prev, next, codeConfig) {
    ...
    return {
        ...
        northPanel: {
            ...
            children: (React.createElement(CodeTransition, { codeConfig: codeConfig, prevFile: nextNorthFile, nextFile: nextNorthFile, t: 1, parentHeight: "1" })),
        },
        southContent: getContentFromFile(nextSouthFile),
        southPanel: inputSouthPanel && {
            tabs: inputSouthPanel.tabs.map(title => ({
            ...
            children: (React.createElement(CodeTransition, { codeConfig: codeConfig, prevFile: nextSouthFile, nextFile: nextSouthFile, t: 1, parentHeight: "1" })),
        },
    };
}
...
function mergeCodeConfig(props) {
    ...
    const codeConfig = Object.assign(Object.assign({}, props.codeConfig), { maxZoom: maxZoom == null ? (_a = props.codeConfig) === null || _a === void 0 ? void 0 : _a.maxZoom : maxZoom, minZoom: minZoom == null ? (_b = props.codeConfig) === null || _b === void 0 ? void 0 : _b.minZoom : minZoom, horizontalCenter: (_d = (_c = props.codeConfig) === null || _c === void 0 ? void 0 : _c.horizontalCenter) !== null && _d !== void 0 ? _d : props.horizontalCenter, lineNumbers: lineNumbers == null
            ...
            : showExpandButton, debug: (_h = props.debug) !== null && _h !== void 0 ? _h : (_j = props.codeConfig) === null || _j === void 0 ? void 0 : _j.debug });
...
function Preview(_a) {
    var { className, files, presetConfig, show, children, codeConfig, style } = _a, rest = __rest(_a, ["className", "files", "presetConfig", "show", "children", "codeConfig", "style"]);
    return (React.createElement("div", { className: "ch-preview" + (className ? " " + className : ""), style: style },
        React.createElement(MiniBrowser, Object.assign({ loadUrl: show, theme: codeConfig.theme }, rest, { children: presetConfig ? (React.createElement(SandpackPreview, { files: files, presetConfig: presetConfig })) : (children) }))));
}
...
function Spotlight(_a) {
    var _b;
    var { children, editorSteps, codeConfig, start = 0, presetConfig, className, style } = _a, rest = __rest(_a, ["children", "editorSteps", "codeConfig", "start", "presetConfig", "className", "style"]);
    ...
    return (React.createElement("section", { className: `ch-spotlight ${presetConfig ? "ch-spotlight-with-preview" : ""} ${className || ""}`, style: style },
...
function Scrollycoding(_a) {
    var { children, editorSteps, codeConfig, presetConfig, start = 0, className, style } = _a, rest = __rest(_a, ["children", "editorSteps", "codeConfig", "presetConfig", "start", "className", "style"]);
    const stepsChildren = React.Children.toArray(children);
    const [state, setState] = React.useState({
        stepIndex: start,
        step: editorSteps[start],
    ...
    return (React.createElement("section", { className: `ch-scrollycoding ${presetConfig ? "ch-scrollycoding-with-preview" : ""} ${className || ""}`, style: style },
...
function Slideshow(_a) {
    var { children, editorSteps, codeConfig, presetConfig, code, className, style } = _a, rest = __rest(_a, ["children", "editorSteps", "codeConfig", "presetConfig", "code", "className", "style"]);
    const stepsChildren = React.Children.toArray(children);
    ...
    return (React.createElement("div", { className: `ch-slideshow ${presetConfig ? "ch-slideshow-with-preview" : ""} ${className || ""}`, style: style },
        ...
        React.createElement("div", { className: "ch-slideshow-notes" },
            React.createElement("div", { className: "ch-slideshow-range" },
                React.createElement("button", { onClick: () => setState(s => {
                ...
                React.createElement("input", { type: "range", min: 0, max: editorSteps.length - 1, value: state.stepIndex, step: 1, onChange: e => setState({
