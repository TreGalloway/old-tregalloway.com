...
export declare const Span: import("@effect-ts/system/Has").Tag<Span>;
export declare function withSpan(name: string, options?: OTApi.SpanOptions): <R, E, A>(effect: T.Effect<R & Has<Span>, E, A>) => T.Effect<R & Has<Tracer>, E, A>;
