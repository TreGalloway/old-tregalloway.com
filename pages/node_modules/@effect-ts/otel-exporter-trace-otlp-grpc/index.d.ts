...
export declare class OTLPTraceExporterConfig {
    readonly config: OTLPExporterConfigNode;
...
export declare const makeOTLPTraceExporterConfigLayer: (config: OTLPExporterConfigNode) => L.Layer<unknown, never, import("@effect-ts/system/Has").Has<OTLPTraceExporterConfig>>;
export declare const makeOTLPTraceExporterConfigLayerM: <R, E>(config: T.Effect<R, E, OTLPExporterConfigNode>) => L.Layer<R, E, import("@effect-ts/system/Has").Has<OTLPTraceExporterConfig>>;
