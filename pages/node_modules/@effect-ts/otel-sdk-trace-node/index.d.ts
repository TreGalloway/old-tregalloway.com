...
export declare const LiveNodeTracerProviderConfig: (config: NodeTracerConfig) => L.Layer<{}, never, import("@effect-ts/system/Has").Has<NodeTracerProviderConfig>>;
...
export declare const NodeProvider: (config?: import("@opentelemetry/sdk-trace-base").TracerConfig | undefined) => L.Layer<{}, never, import("@effect-ts/system/Has").Has<OT.TracerProvider>>;
