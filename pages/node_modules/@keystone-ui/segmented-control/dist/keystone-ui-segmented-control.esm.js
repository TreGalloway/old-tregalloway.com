...
const SegmentedControl = _ref => {
  ...
  const [selectedRect, setSelectedRect] = useState({}); // Because we use radio buttons for the segments, they should share a unique `name`
...
const Item = props => {
  ...
  const inputRef = useRef(null); // do we want to mark the radio item as disabled?
