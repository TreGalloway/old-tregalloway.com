...
export declare type SizeKey = typeof segmentedControlSizeValues[number];
export declare type WidthKey = 'small' | 'medium' | 'large' | 'full';
export declare type ControlTokensProps = {
    size: SizeKey;
    width: WidthKey;
};
export declare type ControlTokens = {
