...
const SegmentedControl = _ref => {
  ...
  const [selectedRect, setSelectedRect] = react.useState({}); // Because we use radio buttons for the segments, they should share a unique `name`
  ...
  const nothingIsSelected = selectedIndex === undefined; // do we want to mark the radio item as disabled?
...
const Item = props => {
  ...
  const inputRef = react.useRef(null); // do we want to mark the radio item as disabled?
