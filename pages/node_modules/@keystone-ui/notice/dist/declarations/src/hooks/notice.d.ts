...
export declare type ToneKey = typeof noticeToneValues[number];
declare type NoticeTokensProps = {
    tone: ToneKey;
};
export declare type NoticeTokens = {
    background?: string;
    borderColor?: string;
    borderRadius?: number;
    borderWidth?: number;
...
declare type NoticeStylesProps = {
    tokens: NoticeTokens;
};
