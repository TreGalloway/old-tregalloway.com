...
var import_getSchemaPathAndPrint = __toModule(require("../utils/getSchemaPathAndPrint"));
...
const _MigrateDev = /* @__PURE__ */ __name(class {
  static new() {
...
`);
          ...
          const schemaPath2 = await (0, import_sdk.getSchemaPath)(args["--schema"]);
