...
async function getSchemaPathAndPrint(schemaPathProvided, postinstallCwd) {
  ...
  const schemaPath = await (0, import_sdk.getSchemaPath)(schemaPathProvided, cwdOptions);
  if (!schemaPath) {
    if (postinstallCwd) {
      import_sdk.logger.warn(`The postinstall script automatically ran \`prisma generate\` and did not find your \`prisma/schema.prisma\`.
...
__name2(getSchemaPathAndPrint, "getSchemaPathAndPrint");
