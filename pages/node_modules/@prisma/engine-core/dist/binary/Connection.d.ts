...
export declare class Connection {
     ...
     * @returns
     */
    raw<R>(method: 'POST' | 'GET', endpoint: string, headers?: Dispatcher.DispatchOptions['headers'], body?: Dispatcher.DispatchOptions['body']): Promise<Result<R>>;
    /**
     ...
     * @returns
     */
    post<R>(endpoint: string, body?: Dispatcher.DispatchOptions['body'], headers?: Dispatcher.DispatchOptions['headers']): Promise<Result<R>>;
    /**
