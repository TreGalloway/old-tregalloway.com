...
import { specifiedScalarTypes, isObjectType, isInputObjectType, isEnumType, isInterfaceType, isScalarType, isUnionType, GraphQLSchema, print, GraphQLObjectType, getNamedType, printType, parse } from 'graphql';
import { scalar } from '@graphql-ts/schema/api-without-context';
...
function extend(extension) {
  return schema => {
    ...
    const updatedSchema = new GraphQLSchema({ ...schemaConfig,
      query: newQueryType,
