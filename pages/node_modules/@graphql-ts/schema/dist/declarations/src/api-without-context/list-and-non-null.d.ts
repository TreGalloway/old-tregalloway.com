 ...
 */
export declare type ListType<Of extends Type<any>> = {
    kind: "list";
    of: Of;
 ...
 * ```
 */
export declare function list<Of extends Type<any>>(of: Of): ListType<Of>;
/**
 ...
 */
export declare type NonNullType<Of extends NullableType<any>> = {
    kind: "non-null";
    of: Of;
    __context: Of["__context"];
 ...
 * ```
 */
export declare function nonNull<Of extends NullableType<any>>(of: Of): NonNullType<Of>;
//# sourceMappingURL=list-and-non-null.d.ts.map